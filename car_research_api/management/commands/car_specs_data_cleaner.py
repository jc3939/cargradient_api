...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        car_specs_df = self.car_specs_df.apply(self.create_and_mapping_features, axis=1).drop(['_id','basic_info', 'car_make','car_model','car_trim','car_year','query_date','query_url','specs_info','vehicleId'],axis=1).to_dict('records')
